...
document.getElementById("cusendcontracttxt").value=dateString;
}
...
$(function() {
	 ...
	 $(".datepicker").datepicker( "option", "defaultDate", "<?php echo $date; ?>" );
...
return false;
	...
	<body>
		...
		<div align="center">
			 ...
			 <div style="width: 950px;"> <img src="logo.png" style="vertical-align:middle" /> </div> 
		...
		<div  style="width: 850px;  ">
			...
			<div>
				...
				<table>
					...
					<td>
						<input type="text" id="cusnametxt" name="cusnametxt"  style="width: 150px; margin-right: 20px;"/>
					</td>
					...
					<td> <input type="text" id="cusid1"  value='<?php $mysql_hostname = "localhost";
$mysql_user = "shoppkd8_gana";
$mysql_password = "v.d.Sudb888";
$mysql_database = "shoppkd8_db_amc";
$bd = mysql_connect($mysql_hostname, $mysql_user, $mysql_password) or die("Opps some thing went wrong");
mysql_select_db($mysql_database, $bd) or die("Opps some thing went wrong");
$result = mysql_query("SELECT MAX(cusid) FROM customer");
while($row = mysql_fetch_array($result)){
echo $row['MAX(cusid)']+1;
}
?>'
						
name="cusid1" style="width: 150px;" > </td>
				...
				<tr style="height: 50px;">
					...
					<td>
				    <textarea id="cusaddresstxt" name="cusaddresstxt"  rows="1" cols="20" >
					...
					<td>
						<input type="text" id="cusphonetxt" name="cusphonetxt"  style="width: 150px;"/>
					</td>
			...
			<div style="float: left; width: 370px; height: 320px; "> <!-- 2 div starts -->
			...
			<table>
				...
				<tr style="height: 30px;">
					...
					<td>
						...
						<select  onchange="test();newcus();" id="cusservicetxt"  name="cusservicetxt"  style="width: 150px;" >
				...
				<tr style="height: 30px;">
					...
					<td>
						<select  onchange="purfrom();" id="purchasefrom"  name="purchasefrom"  style="width: 150px;" >
					...
					<td>
						<input type="text" class="datepicker" id="cusdoptxt" name="cusdoptxt" style="width: 150px;"/>
					</td>
				</tr>
				...
				<tr id="unitinstall" style="height: 30px;">
					...
					<td>
						...
						<select  id="acintplacetxt"  name="acintplacetxt"  style="width: 150px;" >
					...
					<td>
						...
						<select  id="cusunitmaketxt"  name="cusunitmaketxt"  style="width: 150px;" >
                   ...
                   <tr style="height: 30px;">
					...
					<td>
						...
						<select  id="cusunittontxt"  name="cusunittontxt"  style="width: 150px;" >
				 ...
				 <tr id="star" style="height: 30px;">
					...
					<td>
						...
						<select  id="cusacstartxt"  name="cusacstartxt"  style="width: 150px;" >
				  ...
				  <tr style="height: 30px;">
					...
					<td>
						<input type="text" id="cusmodelnotxt" name="cusmodelnotxt"  style="width: 150px;"/>
					</td>
				 </tr>
				 ...
				 <tr id="slno" style="height: 30px;">
					...
					<td>
						<input type="text" id="cusserialnotxt" name="cusserialnotxt"  style="width: 150px;"/>
					</td>
				 </tr>
				 ...
				 <tr style="height: 30px;">
					...
					<td>
						<input type="text" id="compressorslnotxt" name="compressorslnotxt"  style="width: 150px;"/>
					</td>
				 </tr>	
			...
			<div style="float: left; width: 340px; height: 320px; "> <!-- 3 div starts -->
				...
				<table>
					...
					<td>
						<select  id="cuspaymodetxt" onchange="chequedet();"  name="cuspaymodetxt"  style="width: 150px;" >
					...
					<td>
						<input type="text"  id="chequedetailstxt" name="chequedetailstxt" style="width: 150px;"/>
					</td>
				    </tr>
					...
					<td>
					<input type="text"  id="amounttxt" name="amounttxt"  style="width: 150px;"/>	 
					</td>
				    </tr>
				 ...
				 <tr id="cncdop" style="height: 30px; display: none;">
					...
					<td>
						<input type="text" value="Nil" class="datepicker" id="cncdoptxt" name="cncdoptxt"  style="width: 150px;"/>
					</td>
				 </tr>
				 ...
				 <tr id="cncpurdet" style="height: 30px; display: none;">
					...
					<td>
						<input type="text" value="Nil" id="purchasedettxt" name="purchasedettxt"  style="width: 150px;"/>
					</td>
				 </tr>
				 ...
				 <tr id="cncpurinv" style="height: 30px; display: none;">
					...
					<td>
						<input type="text" value="Nil" id="invnotxt" name="invnotxt"  style="width: 150px;"/>
					</td>
				 </tr>
				...
				<tr style="height: 40px;">
					...
					<td>
						<input type="text" id="cusagreenotxt" name="cusagreenotxt"  style="width: 150px;"/>
					</td>
				 </tr>
                 ...
                 <tr style="height: 20px;">
					...
					<td>
						<input type="text" class="datepicker" onchange="funcalenddate();"  id="cusstartcontracttxt" name="cusstartcontracttxt"  style="width: 150px;"/>
					</td>
				 </tr>
                 ...
                 <tr style="height: 40px;">
					...
					<td>
						<input type="text" class="datepicker"  id="cusendcontracttxt" name="cusendcontracttxt"  style="width: 150px;"/>
					</td>
				 </tr>
...
<div style="height:100px; width:550px; float:left; margin-top: 20px;  ">
...
<div id="msgcusdetails"  style=" color: red; float:right; padding-top:10px; ">  </div>
