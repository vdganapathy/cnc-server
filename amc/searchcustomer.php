		...
		<div  style="width: 850px;  ">
			...
			<div>
				...
				<table>
					...
					<td>
						<input type="text" id="cusnametxt" value='<?php echo $row['customername']; ?>' name="cusnametxt"  style="width: 150px; margin-right: 20px;"/>
					</td>
...
<input type="text" id="cusaddresstxt" wrap="true" name="cusaddresstxt" value='<?php echo $row['address']; ?>' style="width: 200px; height: 50px;" >
					...
					<td>
						<input type="text" id="cusphonetxt" name="cusphonetxt" value='<?php echo $row['phone']; ?>'  style="width: 150px;"/>
					</td>
