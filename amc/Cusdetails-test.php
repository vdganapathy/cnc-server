...
return false;
	...
	<div align="center" style="background-color:yellow; width:95%; ">	
		
<div style="background-color:orange; width:94%; margin-right: 30px; ">		


<div style="float: left; width: 120px; height:600px;  background-color: #f0f0f0; padding-right: 30px;"> <!-- 1 div starts -->
...
<div style="float: left; width: 760px; height:600px;  background-color: yellow; padding-right: 30px;">
...
$mysql_password = "v.d.Sudb";
$mysql_database = "shoppkd8_db_amc";
$bd = mysql_connect($mysql_hostname, $mysql_user, $mysql_password) or die("Opps some thing went wrong");
mysql_select_db($mysql_database, $bd) or die("Opps some thing went wrong");
$result = mysql_query("SELECT cusid FROM customer WHERE (SELECT MAX(cusid) FROM customer)");
...
<div style="float: right; width: 340px; height: 320px; "> <!-- 3 div starts -->
